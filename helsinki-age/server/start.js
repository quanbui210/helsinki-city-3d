...
const root=fileURLToPath(new URL('../viewer/dist/',import.meta.url)),api=listingMiddleware(),foundation=foundationMiddleware();
...
createServer((req,res)=>api(req,res,()=>foundation(req,res,async()=>{
  try{
