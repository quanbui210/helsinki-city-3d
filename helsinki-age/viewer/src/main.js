...
$('#cinematic-view').onclick=()=>{if(selectionRecord&&nav&&viewer)cinematic.start({viewer,nav,record:selectionRecord,button:$('#cinematic-view')});};
