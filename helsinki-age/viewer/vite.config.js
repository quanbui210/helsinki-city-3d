...
export default defineConfig(({mode})=>{
 ...
 const listings={name:'listing-search',configureServer(server){server.middlewares.use(middleware);},configurePreviewServer(server){server.middlewares.use(middleware);}};
